        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="bg-white/90 p-6 rounded-lg shadow-lg flex flex-col items-center">
            <div className="mb-6 text-center">
              ...
              <p className="text-gray-700">Rua Paraúna, 70 - Serrano - Belo Horizonte - MG</p>
            </div>
            
            <div className="aspect-w-16 aspect-h-9 w-full mb-6">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3751.8!2d-43.9378!3d-19.9167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTnCsDU1JzAwLjEiUyA0M8KwNTYnMTYuMSJX!5e0!3m2!1spt-BR!2sbr!4v1234567890"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div className="text-center">
              <a
                href="https://www.google.com/maps/search/?api=1&query=Rua+Paraúna,+70+-+Serrano+-+Belo+Horizonte+-+MG"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#f0550e] hover:bg-gray-800 text-white font-bold py-2 px-6 rounded-full transition-all duration-300 transform hover:scale-105"
              >
